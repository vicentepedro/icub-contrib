...
A M\+A\+T\+L\+A\+B scope which displays signal acquired form a Y\+A\+R\+P port along with its F\+F\+T.  
...
A M\+A\+T\+L\+A\+B script launched by this module displays data acquired from Y\+A\+R\+P port. Two type of plot are provided\+: the stripchart and the spectrogram.
