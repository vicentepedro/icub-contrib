...
if(UNIX)
   set(OpenTLD_WIN_LIB_SUBPATH "")
   mark_as_advanced(OpenTLD_WIN_LIB_SUBPATH)
else()
   set(OpenTLD_WIN_LIB_SUBPATH Release)
endif()
...
if(OpenTLD_ROOT AND OpenTLD_DIR)
   ...
   find_library(OpenTLD_OpenTLD_LIB NAMES opentld  PATHS ${OpenTLD_DIR}/lib ${OpenTLD_DIR}/lib/${OpenTLD_WIN_LIB_SUBPATH})
   find_library(OpenTLD_CVBLOBS_LIB NAMES cvblobs  PATHS ${OpenTLD_DIR}/lib ${OpenTLD_DIR}/lib/${OpenTLD_WIN_LIB_SUBPATH})
   find_library(OpenTLD_CONFIG_LIB  NAMES config++ PATHS ${OpenTLD_DIR}/lib ${OpenTLD_DIR}/lib/${OpenTLD_WIN_LIB_SUBPATH})
